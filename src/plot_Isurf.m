...
Sun = [0:100:1000];
I1 = lut(11,11,:)    %Sun = 1.0, i.e. 1 kW/m2
I2 = lut(5,11,:);    %0.5 kW/m2
...
current_data = transpose(squeeze(lut(:,11,:))); % Angenommen, dass dies korrekt umgeformt wurde zu passender Größe
